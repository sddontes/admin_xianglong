  ...
  <section>
    ...
    <section>
      <el-table :data="gridData" highlight-current-row border v-loading="gridLoading">
        ...
        <el-table-column label="问题类型" prop="questionType" min-width="100">
        ...
        <el-table-column label="客服姓名" prop="operatorName" min-width="100"></el-table-column>
    ...
    methods: {
      ...
      imgReview(row) {
        ...
        imgArr.forEach(function (e, i) {
          imgArr[i] = Config.imageUrl+"feedback/"+ e;
          // imgArr[i] = 'http://image.yqguan.com/MyDownload/feedback/' + e;
        });
