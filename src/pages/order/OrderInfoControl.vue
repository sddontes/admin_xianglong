  ...
  export default {
    ...
    methods: {
        ...
        this.$http.post("manage/completionInfoByUserUuid",{userUuid:this.userUuid}).then((response) =>{  
          ...
          if(1 == body.code){
            if(body.data){
              ...
              this.addreBook(channel,0);        //通讯录信息兼容360渠道
          ...
          if(1 == body.code && body.data){
            try{
              ...
              if(result){
                ...
                this.getTop20ContactList(channel,!e)
              }
      ...
      addreBook(channel,e){
        ...
        let _url = '';
        let _data = {};
        // (channel == 11 || channel == 50) ? _url = 'manage/rong360UserContactByUserUuidMongo' : _url = 'manage/orderUserContactMongoByOrderNo';
        // (channel == 11 || channel == 50) ? _data = {uuid: this.userUuid,channel:channel} : _data = {uuid: this.uuid};
